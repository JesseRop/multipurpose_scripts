...
def main(read_bam, output_bam, namefile, name, tag_name):
    d = {}
    celltype_info = {}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", help="classification name")
    parser.add_argument("--tag_name", help="Tag name to add to relevant sequence")

    args = parser.parse_args()
    main(args.read_bam, args.output_bam, args.namefile, args.name, args.tag_name)
